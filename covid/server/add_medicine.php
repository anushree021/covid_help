...
if(isset($_POST['insert'])) 
{
	...
	$query="insert into medicine set med_name='".$_POST['name']."', descrip='".$_POST['descrip']."', symptom_id='".$_POST['category']."', price='".$_POST['price']."', image='".$file."'";
...
<div class="menubar">
	...
	<form method="post" action="" enctype="multipart/form-data"> 
		<table>
			<tr>
				<td>Medicine Name : </td>
				<td><input type="text" name="name" value="" placeholder="Enter medicine name"></td>
			</tr>
			<tr>
				<td>Description : </td>
				<td><input type="text" name="descrip" value="" placeholder="Enter medicine description"></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Price : </td>
				<td><input type="number" name="price" value="" placeholder="Enter medicine price"></td>
			</tr>
			<tr>
				<td>Image : </td>
