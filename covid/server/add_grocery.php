...
if(isset($_POST['insert'])) 
{
	...
	$query="insert into grocery set g_name='".$_POST['g_name']."', c_id='".$_POST['category']."', price='".$_POST['price']."', image='".$file."'";
	mysqli_query($con,$query); 
}
$query="select * from grocery_category where status='1'"; #select courses which have active(1) status
...
<div class="menubar">
	...
	<form method="post" action="" enctype="multipart/form-data"> 
		<table>
			<tr>
				<td>Grocery Name : </td>
				<td><input type="text" name="g_name" value="" placeholder="Enter grocery name"></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Price : </td>
				<td><input type="input" name="price" value="" placeholder="Enter grocery price"></td>
			</tr>
			<tr>
				<td>Image : </td>
