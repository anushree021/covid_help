  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="client\images1\photo1627732754.jpeg" alt="Hilfe" >
      ...
      <div class="item">
        <img src="client\images1\photo1627732790.jpeg" style="width:100%;" alt="Hilfe">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="client\images1\makingmedicines784.jpg" alt="Hilfe" style="width:100%; height:50%;">
        <div class="carousel-caption">
        <h1>Hilfe </h1>
        <div id="h">
      ...
      <div class="item">
        <img src="client\images1\photo1627732818.jpeg" alt="Hilfe" style="width:100%; height:50%;">
        <div class="carousel-caption">
    ...
    <div class="container text-center">
         ...
         <a href="client/guidance.php"> <img src=" https://www.easa.europa.eu/sites/default/files/styles/main_view/public/ifu/EASA-website-guidance-news-item_0.jpg?itok=Z30b3mTL" height="100" width="120">  </a>
         ...
         <div class="col-sm-8" id="col2">
          ...
          <p>	The COVID-19 pandemic has led to a dramatic loss of human life worldwide and presents an unprecedented challenge to public health, food systems and the world of work. The economic and social disruption caused by the pandemic is devastating.
          	The pandemic has been affecting the entire food system and has laid bare its fragility. So, we as a team has decided to help people
    ...
    <br> Along with that, we have alot of other facilities for the general masses as well. To know about some COVID-19 mythbusters, click here <br>
     <a href="client/mythbusters.php"> <img src="https://www.hpsj.com/wp-content/uploads/2020/03/myth-icon-01.png" height="100" width="120"> </a></div>
</div></div> </div>
</body>
</html>
