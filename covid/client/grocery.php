...
$query="select * from grocery_category where status='1'";
$result=mysqli_query($con,$query);
?>

<style type="text/css">
  body{
    background-image: url(https://st2.depositphotos.com/1800516/12261/i/950/depositphotos_122616428-stock-photo-blur-image-background-of-supermarket.jpg);
...
<div id="main" class="main">
  ...
  <div class="grid-box">
    ...
    <div class="grid">
      ...
      <div><?php echo $fetch1->g_name?></div>
      <div>₹<?php echo $fetch1->price?>.00/kg</div>
      <div><a href="payment_gateway/cart.php?item_id=<?php echo $fetch1->g_id; ?>&amp table_id=2">Add to Cart</a></div>
    </div>
    <?php 
    }
    }
