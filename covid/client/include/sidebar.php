<?php
  ...
  $query3="select * from symptom where status='1'";
...
<div id="sidenav" class="sidenav">
  ...
  <br>
  <button class="dropdown-btn"><a href="./medicine.php">Medicines</a><i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
    <?php while($fetch3=mysqli_fetch_object($result3)) {?>
    <a href="#<?php echo $fetch3->name; ?>"><?php echo $fetch3->name?></a>
    <?php }?>
  </div>
